...
def parse_args():
    ...
    # the path of the file containing the target label; generated by set_target_label.py
...
if __name__ == '__main__':
    ...
    #     avg_stoi_score = np.mean(stoi_scores)
    #
    #     print(f'Folder {i} accuracy: {accuracy:.2f}%')
    #     print(f'Folder {i} SNR: {snr:.2f} dB')
    #     print(f'Folder {i} STOI: {avg_stoi_score:.2f}')
    #
    #     total_accuracy += accuracy
    #     total_snr += snr
    #     total_stoi += avg_stoi_score
    #
    # average_accuracy = total_accuracy / num_folders
    # average_snr = total_snr / num_folders
    # average_stoi = total_stoi / num_folders
    #
    # print(f'Average accuracy: {average_accuracy:.4f}%')
    # print(f'Average SNR: {average_snr:.4f} dB')
    # print(f'Average STOI: {average_stoi:.4f}')
